...
class BertOrigin(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        ...
        # original_shape = list(encoded_layers.size())
        # encoded_layers_tmp = encoded_layers.view(original_shape[0], -1, 3)
        # cross_out = torch.cross(encoded_layers_tmp, encoded_layers_tmp, dim=2)
        # pooled_output: [batch_size, dim=768]
        # encoded_layers: [batch_size, length=512, dim=768]
