...
class TextCNN(nn.Module):
  def __init__(self, vocab_size, embedding_dim, kernel_sizes, num_channels, vectors):
...
vectors = torch.tensor(torch.rand(2000, 100))
vocab_size, embedding_dim, kernel_sizes, num_channels = 2000, 100, [3, 4, 5], [100, 100, 100]
net = TextCNN(vocab_size, embedding_dim, kernel_sizes, num_channels, vectors)
print(net)
