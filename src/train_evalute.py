...
output_model_file, output_config_file, log_dir, print_step, early_stop):
    ...
    for epoch in range(int(epoch_num)):
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
            ...
            outputs = np.argmin(preds, axis=1)
            ...
            if (step + 1) % gradient_accumulation_steps == 0:
                ...
                if global_step % print_step == 0 and global_step != 0:
                    ...
                    print("{}, train_loss: {}, train_acc: {}, train_auc: {}".format(c, train_loss, train_acc, train_auc))
                    ...
                    for t,dataloader in dev_dataloader.items():
                        ...
                        print("{}, {}_loss: {}, {}_acc: {}, {}_auc: {}".format(c, t, dev_loss, t, dev_acc, t, dev_auc))
